...
%
% Inputs:   B      # true coefficients of X part 
%                        ([1 0.5], by default)
%        	C      # true coefficients of MA part (noise filter)
%                        ([1 -1 0.2], by default)
%        	D      # true coefficients of MA part (noise filter)
%                        ([1 -0.1 0.45], by default)
%           F      # true coefficients of X part 
...
Nf = 5 ; 			% Maximum index of x part. 
Nb = 5 ;			% Maximum index of X part. 
Nc = 5 ;			% Maximum index of MA part. 
Nd = 5 ;			% Maximum index of MA part. 
      ...
      for nf=1:Nf
        if (~pf)
          ...
          if ((nb>1) || (nc>1) || (nd>1) || (nf>1))
             ...
             Mid = bj(Did,[nb-1 nc-1 nd-1 nf nk]) ; 
...
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
[nb,nc,nd,nf, GAICR] = GAIC_R4(Lambda,N);
